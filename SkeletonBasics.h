...
private:
    ...
    /// </summary>
	void DrawStr(int x,int y,string letter,int Len);
	void DrawSingleChar(int x,int y,char letter,int Len);
    void                    DiscardDirect2DResources( );
	void DrawNum(int x,int y,int number,int L,int count);
    void                    DrawSingleNum(int x,int y,int number,int L);
	void DrawRect(Square sqr);
	void showLife(int life,int scrHeight);
	void hitDetect(Square sqr,int x,int y);
	void bottomDetect(Square sqr,int width,int height);
    /// <summary>
